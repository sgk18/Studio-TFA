  ...
  if (success === "check_email") {
    return (
      <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-12">
        <div className="w-full max-w-md text-center glass-panel rounded-[1.75rem] border border-white/45 p-10 shadow-[0_25px_80px_rgba(18,26,45,0.2)]">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-24 pb-12">
      <div className="w-full max-w-md glass-panel rounded-[1.75rem] border border-white/45 p-8 sm:p-10 shadow-[0_25px_80px_rgba(18,26,45,0.2)]">
        ...
        <form action={signUpWithGoogle} className="space-y-3">
